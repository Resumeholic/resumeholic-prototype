...
/**
 * Servlet responsible for showing resumes.
 * @author Anthony Than Poovong, Caleb Lam
 */
@WebServlet(name = "Resumes", urlPatterns = {"/Resumes"})
public class Resumes extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getSession().setAttribute("currentResume", null);
        request.setAttribute("resumesInfo", Business.getResumes(cookieUser.getId(), token).getResumes());
            RequestDispatcher rd= request.getRequestDispatcher("userresumes.jsp");
