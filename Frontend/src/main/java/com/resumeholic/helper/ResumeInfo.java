...
public class ResumeInfo {
    ...
    @XmlTransient
    PersonalInfoHeader personalInfoHeader = null;
    ...
    public PersonalInfoHeader getPersonalInfoHeader() {
        return personalInfoHeader;
    }
    
    public void setPersonalInfoHeader(PersonalInfoHeader newHeader) {
        personalInfoHeader = newHeader;
    }
}
